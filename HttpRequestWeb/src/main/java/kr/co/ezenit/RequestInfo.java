...
public class RequestInfo {
	...
	@RequestMapping("/requestInfo")		//2. URL과 메소드를 연결 
	public void ezen(HttpServletRequest request) {
		...
		//프로토콜의 종류와 버전 
		System.out.println("request.getCharacterEncoding()= " + request.getProtocol());
		//요청 
		System.out.println("request.getCharacterEncoding()= " + request.getMethod());
	}
}
