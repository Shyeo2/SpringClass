...
public class DMLTest {
 ...
 //  @Test
   public void insertUserTest() throws SQLException	{
	   User user = new User("ezen", "9070", "ezen", "ezen@gmail.com", new Date() , "fb", new Date());
	   deleteAll();
...
//사용자 정보를 t_user 테이블에 저장하는 메소드
 ...
 //  @Test
   public void selectUserTest() throws SQLException {
	   deleteAll();
	   User user = new User("ezen", "0111", "ezen","eznen@gmail.com", new Date(), "fb", new Date());
	   int rowCnt = insertUser(user);
...
//   @Test
   public void deleteUserTest() throws SQLException {
	   ...
	   User user = new User("ezen2", "0111", "ezne2", "ezne@gmail.com", new Date(), "fb", new Date());
...
//	   return rowCnt;
   ...
   public void updateUserTest() throws SQLException {
	   deleteAll();
	   User user = new User("ezen3", "0111", "ezen3", "ezen5@gmail.com", new Date(), "fb", new Date());
	   int rowCnt = insertUser(user);
	   assertTrue(rowCnt==1);
